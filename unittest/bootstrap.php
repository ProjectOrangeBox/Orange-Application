...
define('ORANGEDIR', realpath(__ROOT__ . '/vendor/orange/framework/src'));

// The framework's global helpers (logMsg, container, config, ...) are normally
// loaded at runtime by Application::preContainer() via dynamic include_once, not
// through composer's autoloader. Load them here so tests that instantiate
// framework services (Data, Output, controllers, ...) have them available -
// this mirrors vendor/orange/framework/unittest/bootstrap.php.
