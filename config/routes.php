...
// NOTE! *** only use this in development mode
// use RouterDetector::export(...) to echo a production level route array
// then place that your production route config directory
