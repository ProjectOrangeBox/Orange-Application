...
// Generated by config\development\ConfigDetector - do not edit by hand.
...
return [
    'config' => [
        'application' => [
            ...
            'required helpers' => [
                __ROOT__ . '/vendor/orange/framework/src/config/../helpers/wrappers.php',
                __ROOT__ . '/vendor/orange/framework/src/config/../helpers/errors.php',
                __ROOT__ . '/vendor/orange/framework/src/config/../helpers/helpers.php',
            ],
            'h1' => 'Hello World!',
            'this file' => __ROOT__ . '/config/application.php',
...
',
        ...
        'routes' => [
            ...
            404 => [
                ...
                'url' => '(.*)',
                'callback' => [
                    'orange\\framework\\controllers\\FourohfourController',
                    'index',
                ],
                'name' => 'fourohfour',
            ],
            'home' => [
                ...
                'url' => '/',
                'callback' => [
                    'orange\\framework\\controllers\\HomeController',
                    'index',
                ],
                'name' => 'home',
            ],
        ...
        'services' => [
            ...
            'config' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\ConfigInterface {
                return \orange\framework\Config::getInstance($container->get('$application'));
            },
            'log' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\LogInterface {
                return \orange\framework\Log::getInstance($container->config->log);
            },
            'events' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\EventInterface {
                return \orange\framework\Event::getInstance($container->config->event);
            },
            'input' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\InputInterface {
                return \orange\framework\Input::getInstance($container->config->input);
            },
            'output' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\OutputInterface {
                return \orange\framework\Output::getInstance($container->config->output, $container->input);
            },
            'router' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\RouterInterface {
                return \orange\framework\Router::getInstance($container->config->routes, $container->input);
            },
            'data' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\DataInterface {
                return \orange\framework\Data::getInstance($container->config->data);
            },
            'viewFinder' => function (\orange\framework\interfaces\ContainerInterface $container): \orange\framework\interfaces\ViewFinderInterface {
                return \orange\framework\ViewFinder::getInstance($container->config->get('views', []));
            },
    ...
    'deferred' => [
        'input' => [
            __ROOT__ . '/vendor/orange/framework/src/config/input.php',
        ],
    ],
];
