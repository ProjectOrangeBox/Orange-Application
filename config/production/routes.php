...
return [
    'routes' => [
        ...
        ['method' => 'post', 'url' => '/api/login', 'callback' => [\api\controllers\AuthController::class, 'login'], 'name' => 'auth_login'],
        ['method' => 'post', 'url' => '/api/logout', 'callback' => [\api\controllers\AuthController::class, 'logout'], 'name' => 'auth_logout'],
        ['method' => 'get', 'url' => '/api/me', 'callback' => [\api\controllers\AuthController::class, 'me'], 'name' => 'auth_me'],
